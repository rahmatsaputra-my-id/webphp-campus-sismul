...
<?php endif; ?> -->
  <form enctype="multipart/form-data" action="<?php echo site_url('home/register')?>" method="post" class="col s12">
    <div class="row">
    ...
    <div class="row">
      <div class="input-field col s12">
        <input type="text" onkeyup="this.value = this.value.toLowerCase();" name="repassword" id="repassword" required class="validate" placeholder="RePassword">
      </div>
    </div>
